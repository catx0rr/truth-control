...
```bash
openclaw plugins install /absolute/path/to/truth-recovery-plugin
...
```text
~/.openclaw/extensions/truth-recovery-plugin/
```
...
- only explicit structured corrections auto-record immediately
